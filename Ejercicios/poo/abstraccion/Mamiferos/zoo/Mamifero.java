...
public abstract class Mamifero {
    ...
    public String toString() {
        return String.format("%s {Habitat=%s, Altura=%.2f m, Largo=%.2f m, Peso=%.2f kg, Nombre Científico=%s}",
                this.getClass().getSimpleName(), habitat, altura, largo, peso, nombreCientifico);
    }
